        ...
        <div className="home">  
            ...
            <section>
                <div className="cards-container">
                    ...
                    <Card title="02" img={youtubeImg} subtitle="Tiktok" description="Faça sua criatividade brilhar em vídeos curtos e envolventes que vão cativar a comunidade global do TikTok." cardColor="#F9EB98"></Card>
                    <Card title="03" img={youtubeImg} subtitle="Facebook" description="Conecte-se com sua audiência de forma autêntica e impactante através de vídeos que se destacam no feed do Facebook." cardColor="#C0D9DD"></Card>
                    <Card title="04" img={youtubeImg} subtitle="Instagram" description="Compartilhe suas histórias de maneira única e conquiste milhões de likes no Instagram utilizando Stories e Reels." cardColor="#6975E8"></Card>
                </div>
            </section>
        </div> 
    );
